"""Reporte de Gestiones (Atención) — KPIs + data JSON."""
...
class AtencionGestionReport(Base):
    __tablename__ = "atencion_gestion_reports"
    ...
    cerrados: Mapped[int] = mapped_column(Integer, default=0)
    pendientes: Mapped[int] = mapped_column(Integer, default=0)
    pct_cerrados: Mapped[float] = mapped_column(Numeric(6, 2), default=0)
