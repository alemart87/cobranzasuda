"""Base Adicional upload — carteras que se gestionan pero NO reciben pagos.

`tipo` ∈ {'debitos_automaticos', 'bancard'}.
"""
...
class BaseAdicionalUpload(Base):
    __tablename__ = "base_adicional_uploads"
