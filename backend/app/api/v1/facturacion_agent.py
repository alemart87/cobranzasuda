"""Endpoints del Agente de Facturación · Televentas Claro (conversaciones, mensajes, chat SSE).

Acceso: superadmin (siempre) + analistas habilitados al módulo (granted_modules).
Reusa AgentConversation/AgentMessage con scope='facturacion'. Auditoría en cada mensaje.
"""
...
from ..deps import CurrentUser, client_ip, require_facturacion_access


router = APIRouter(prefix="/facturacion-agent", tags=["facturacion-agent"])
